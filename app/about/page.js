    ...
    <>
      ...
      <div className="amain pt-20 md:pt-0 h-screen w-screen md:w-3/4 md:absolute left-[379px] overflow-x-hidden">
        ...
        <div className="font-montserrat aboutcontent  text-gray-500  min-h-[80vh] h-fit px-5  md:px-20 pb-10 ">
          <p className="ist  text-2xl text-gray-500 mb-10 " >Hello&#33; I&apos;m Harsh Saini, a passionate web developer . I have a undergraduate degree in Bachelor of Computer Application from Maharshi Dayanand University Rohtak. 🎓</p>
