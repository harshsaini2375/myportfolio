    ...
    <>
      ...
      <div className="pmain pt-10 md:pt-0 w-screen md:w-3/4 md:absolute left-[375px] ">
        ...
        <div className="projects md:pb-0 pb-10 w-full mb-5 h-fit px-3 md:px-12 justify-center md:justify-start flex gap-5 md:gap-10 flex-wrap ">
          ...
          <Card image="/getmeachaiimage.png" name='Get-me-a-Chai' description="A Patreon Clone where you can support your favorite creators. With this platform, users can seamlessly make payments to creators they admire." tech={['Next.js']} git="https://github.com/harshsaini2375/Get-me-a-chai" demo="https://get-me-a-chai-tau.vercel.app/" />
