    ...
    <>
      ...
      <div className="pmain pt-10 md:pt-0 w-screen md:w-3/4 md:absolute left-[375px] ">
        ...
        <div className="projects md:pb-0 pb-10 w-full mb-5 h-fit px-3 md:px-12 justify-center md:justify-start flex gap-5 md:gap-10 flex-wrap ">
          ...
          <Card image="/todolist.png" name='To-do-list' description="A task management application that helps users organize their daily activities. Features include adding tasks and marking items as complete." tech={['React', 'Tailwind', 'React icons']} git="https://github.com/harshsaini2375/To-do-list-" demo="https://to-do-list-ten-lemon-96.vercel.app/" />
