...
const Sidebar = () => {
    ...
    return (
        <>
            <div className="left z-10 rounded-3xl border-[5px] md:border-[10px] border-white bg-[#618dea]  text-[#cedcf8] w-full md:w-1/4 h-[70px] md:h-[99vh] fixed top-0 left-0 md:block  flex md:gap-0 gap-2">
        
                         <div className="up md:py-12 w-[10%] md:w-full md:mr-0 mr-3  md:flex flex-col justify-center items-center ">
                ...
                <div className="down relative md:py-5 px-2 text-sm md:text-lg justify-between md:justify-normal flex flex-row md:flex-col md:w-[90%] w-full h-fit md:h-[60vh] md:pl-20">

                    <Link className='h-fit' href="/">
                        <div onClick={() => { forfocus('valhome') }} className={home ? "home text-white  cursor-pointer font-bold   w-fit md:px-5  py-7 h-12   md:hover:bg-[#3c72e7]  rounded-full flex gap-2  items-center " : "home    cursor-pointer font-bold  w-fit md:px-5  py-7 h-12   md:hover:bg-[#3c72e7]  rounded-full flex gap-2  items-center "}>
                    ...
                    <Link href="/projects">
                        <div onClick={() => { forfocus('valproject') }} className={project ? "projects text-white cursor-pointer font-bold   w-fit md:px-5  py-7 h-12 md:hover:bg-[#3c72e7]  rounded-full flex gap-2  items-center " : "projects cursor-pointer font-bold   w-fit md:px-5  py-7 h-12 md:hover:bg-[#3c72e7]  rounded-full flex gap-2  items-center "}>
                    ...
                    <Link href="/about">
                        <div onClick={() => { forfocus('valabout') }} className={about ? "about text-white cursor-pointer font-bold   w-fit md:px-5  py-7 h-12 md:hover:bg-[#3c72e7]  rounded-full flex gap-2  items-center " : "about cursor-pointer font-bold   w-fit md:px-5  py-7 h-12 md:hover:bg-[#3c72e7]    rounded-full flex gap-2  items-center "}>
                    ...
                    <Link href="/contact">
                        <div onClick={() => { forfocus('valcontact') }} className={contact ? "contact text-white cursor-pointer font-bold   w-fit md:px-5  py-7 h-12 md:hover:bg-[#3c72e7]  rounded-full flex gap-2  items-center " : "contact cursor-pointer font-bold   w-fit md:px-5  py-7 h-12  md:hover:bg-[#3c72e7]  rounded-full flex gap-2  items-center "}>
