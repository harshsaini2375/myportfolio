    ...
    return (
        <>
            <Link className='h-fit' href={props.link} target="_blank" >
                <div className='card hover:bg-[#f3f7ff] cursor-pointer border-slate-300 border-2 h-40 md:w-[150px] w-[130px] rounded-3xl md:mb-10 p-4
        ...
        transition-shadow duration-300'>
                    ...
                    <div className="username text-slate-500 text-xs md:text-sm text-wrap break-words">{props.username}</div>
